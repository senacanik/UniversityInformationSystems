...
namespace Cbu
{
	public partial class Rol : Form
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				baglanti.Open();
				SqlCommand komut = new SqlCommand("select * from rols where rolName like'%" + textBox1.Text + "%'", baglanti);
		...
		private void button2_Click(object sender, EventArgs e)
		{
			...
			{
				baglanti.Open();
				SqlCommand komut = new SqlCommand("insert into rols(rolName) values(@rolName)", baglanti);
				komut.Parameters.AddWithValue("@rolName", textBox1.Text);
		...
		private void button3_Click(object sender, EventArgs e)
		{
			...
			{
				baglanti.Open();
				SqlCommand komut = new SqlCommand("delete from rols where rolName = @rolName", baglanti);
				komut.Parameters.AddWithValue("@rolName", textBox1.Text);
				komut.ExecuteNonQuery();
				DataShow("select * from rols");
				baglanti.Close();
		...
		private void button4_Click(object sender, EventArgs e)
		{
			...
			{
				baglanti.Open();
				SqlCommand komut = new SqlCommand("update rols set rolName='" + textBox1.Text + "' where rolName='" + dataGridView1.CurrentRow.Cells[1].Value.ToString() + "'", baglanti);//currentrow geçerli satır,cell hücre
				komut.ExecuteNonQuery();
				DataShow("select * from rols");
				baglanti.Close();
